...
public class BackgroundTaskStoreDetails extends AsyncTask<String, Item, Void> {
    Context ctx;
    ...
    String json_String = "http://0llum.bplaced.net/ecoCrats/DisplayStoreDetails.php";

    public BackgroundTaskStoreDetails(Context ctx, RecyclerView recyclerView) {
        this.ctx = ctx;
    ...
    protected void onPreExecute() {
        ...
        adapter = new StoreDetailsAdapter(arrayList, ctx);
