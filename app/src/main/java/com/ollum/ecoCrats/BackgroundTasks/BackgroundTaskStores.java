...
public class BackgroundTaskStores extends AsyncTask<String, Store, Void> {
    ...
    String json_String = "http://0llum.bplaced.net/ecoCrats/DisplayStores.php";

    public BackgroundTaskStores(Context ctx, RecyclerView recyclerView) {
        this.ctx = ctx;
    ...
    protected void onPreExecute() {
        ...
        adapter = new StoresAdapter(arrayList, ctx);
