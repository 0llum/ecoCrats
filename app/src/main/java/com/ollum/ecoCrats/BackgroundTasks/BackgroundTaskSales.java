...
public class BackgroundTaskSales extends AsyncTask<String, Item, Void> {
    ...
    String json_String = "http://0llum.bplaced.net/ecoCrats/DisplaySales.php";

    public BackgroundTaskSales(Context ctx, RecyclerView recyclerView) {
        this.ctx = ctx;
